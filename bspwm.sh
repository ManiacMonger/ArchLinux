...
sudo pacman -S --noconfirm xorg light-locker lightdm bspwm sxhkd firefox rxvt-unicode picom nitrogen lxappearance dmenu nautilus arc-gtk-theme arc-icon-theme vlc rofi scrot dunst pacman-contrib
